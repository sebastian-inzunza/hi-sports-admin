          ...
          <div className="mt-8 flex w-full items-center justify-between space-s-4">
            <div className="w-1/2">
              <Button
                ...
                variant="custom"
                className={cn(
                  "w-full rounded bg-accent px-4 py-2 text-center text-base font-semibold text-light shadow-md transition duration-200 ease-in hover:bg-accent-hover focus:bg-accent-hover focus:outline-none",
                  cancelBtnClassName
                )}
              >
                {t(cancelBtnText)}
            ...
            <div className="w-1/2">
              <Button
                ...
                variant="custom"
                className={cn(
                  "w-full rounded bg-red-600 px-4 py-2 text-center text-base font-semibold text-light shadow-md transition duration-200 ease-in hover:bg-red-700 focus:bg-red-700 focus:outline-none",
                  deleteBtnClassName
                )}
              >
                {t(deleteBtnText)}
